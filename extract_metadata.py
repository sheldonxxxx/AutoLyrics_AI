    ...
    try:
        ...
        for key, value in tags.items():
            ...
            if key_lower in ['title', 'tracktitle', '©nam', 'tit2', 'tit3', 'title']:
                priority = 10  # Title
            elif key_lower in ['artist', 'albumartist', 'tpe1', 'tpe2', '©art', 'aart', 'tp1', 'tp2']:
                priority = 20  # Primary artist tags
            elif key_lower in ['composer', 'band', 'ensemble', '©art', 'tpe3', 'tpe4', 'tcom', 'text']:
        ...
        for priority, key_lower, value in prioritized_tags:
            ...
            if key_lower in ['title', 'tracktitle', '©nam', 'tit2', 'tit3', 'title']:
                if metadata['title'] is None:
                    ...
                    extracted_value = str(value[0]) if isinstance(value, list) and len(value) > 0 else str(value)
                    if extracted_value and extracted_value.strip():  # Check if value is not None, empty, or just whitespace
